...
public class Test_03_15 extends CreateExtetReport {

    @Test
    public void Dar_Parte_Moto_Golpe_Sin_Contrarios_Lunas() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, moto, tiene un golpe roce o impacto, sin contrarios, Lunas");
