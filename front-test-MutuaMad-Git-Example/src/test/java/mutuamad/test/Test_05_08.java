...
public class Test_05_08 extends CreateExtetReport{

    @Test
    public void Editar_Datos_Tomador_Contacto_Calle() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Editar datos del Tomador - Calle");
        ...
        String reset = insuranceScreen.getPersonStreet();
        insuranceScreen.setPersonStreet("Dirección pruebas");
        Utilities.sleep(2000);
        insuranceScreen.scrollDown();
        insuranceScreen.clicButtonSaveData();
        Utilities.sleep(10000);
        //Verify datas were updated
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Editar datos del Tomador - Calle");
        ...
        insuranceScreen.scrollDown();
        insuranceScreen.clickButtonModifyInfo();
        insuranceScreen.setPersonStreet(reset);
        Utilities.sleep(2000);
        insuranceScreen.scrollDown();
        insuranceScreen.clicButtonSaveData();
        Utilities.sleep(5000);
        //Verify datas were restored
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Restaurar .- datos del Tomador - Calle");
