...
public class Test_15_03 extends CreateExtetReport {

    @Test
    public void Editar_Contacto_Mail_Telefono() throws Exception {
        System.out.println("[CP_START] [15_03]");
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Editar datos de contacto mail y tlf");
        ...
        ExtentTest node2 = test1.createNode("Steps - Editar Contacto - Mail & Mail");
        ...
        // Set the new mail
        dataContact.setTextMail("testUser@hotmail.com");
