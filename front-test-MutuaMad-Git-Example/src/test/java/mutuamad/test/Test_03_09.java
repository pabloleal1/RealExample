...
public class Test_03_09 extends CreateExtetReport {



    @Test
    public void Dar_Parte_Coche_Incendio() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, coche, ha habido un incendio");
