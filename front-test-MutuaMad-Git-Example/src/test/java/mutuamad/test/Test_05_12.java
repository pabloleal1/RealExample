...
public class Test_05_12 extends CreateExtetReport {

    @Test
    public void Editar_Datos_Tomador_Contacto_Telefono() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Editar datos del Tomador - Numero de telefono");
        ...
        String reset = insuranceScreen.getPersonPhoneNumber();
        ...
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Editar datos del Tomador - Numero de telefono");
        ...
        insuranceScreen.scrollDown();
        insuranceScreen.clickButtonModifyInfo();
        insuranceScreen.setPersonPhoneNumber(reset);
        Utilities.sleep(2000);
        insuranceScreen.scrollDown();
        insuranceScreen.clicButtonSaveData();
        Utilities.sleep(5000);
        //Verify datas were restored
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Restaurar .- datos del Tomador - Numero de telefono");
