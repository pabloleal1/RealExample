...
public class Test_09_02 extends CreateExtetReport {

    @Test
    public void Buscar_Taller_Coche_Carroceria() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Buscar taller coche, carrocerias");
        ...
        ExtentTest node2 = test1.createNode("Steps - Buscar Taller - Ccche, Carroceria");

        //TEST START .-  Search Car Workshop by Car Body
        ...
        Utilities.sleep(2000);
        carWorkshopScreen.clickCarBodyFilter();
        Utilities.sleep(2000);
