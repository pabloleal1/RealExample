...
public class Test_05_11 extends CreateExtetReport {

    @Test
    public void Editar_Datos_Tomador_Contacto_Provincia() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Editar datos del Tomador - Provincia");
        ...
        String reset = insuranceScreen.getPersonProvince();
        ...
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Editar datos del Tomador - Provincia");
        ...
        insuranceScreen.scrollDown();
        insuranceScreen.clickButtonModifyInfo();
        insuranceScreen.setPersonProvince(reset);
        Utilities.sleep(2000);
        insuranceScreen.scrollDown();
        insuranceScreen.clicButtonSaveData();
        Utilities.sleep(5000);
        //Verify datas were restored
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Restaurar .- datos del Tomador - Provincia");
