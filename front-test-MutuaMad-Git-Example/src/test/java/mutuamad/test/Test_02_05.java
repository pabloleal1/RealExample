...
public class Test_02_05 extends CreateExtetReport {

    @Test
    public void Solo_poliza_Vida () throws Exception {

        //Test user
        String User_Only_Life = "Vida";
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Usuario solo poliza Vida");
        ...
        cp1.execute(User_Only_Life, test1);

        //TEST START .-
        ExtentTest node2 = test1.createNode("Home, Only Policy - Vida");
