...
public class Test_03_17 extends CreateExtetReport {

    @Test
    public void Dar_Parte_Moto_Robo_Moto_Aparicion() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, moto, me han robado, me han robado mi coche, SI ha aparecido");
        ...
        //TEST START .- Open new MotorBike report Stolen ShowedUp
        ...
        Utilities.sleep(2000);
        reportsScreen.clickMyVehicleShowedUp();
        Utilities.sleep(2000);
        ...
        node3.log(Status.INFO, "Click on How has it appeared");
