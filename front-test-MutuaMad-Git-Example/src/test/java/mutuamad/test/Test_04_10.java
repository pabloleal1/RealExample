...
public class Test_04_10 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_NoArranca() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(no arranca)");
        ...
        assistanceScreen.clickFailureAssistance();
        Utilities.sleep(5000);
        assistanceScreen.clickCarAssistanceNotStart();
        Utilities.sleep(5000);
