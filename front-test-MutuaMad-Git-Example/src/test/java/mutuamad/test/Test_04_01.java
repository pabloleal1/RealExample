...
public class Test_04_01 extends CreateExtetReport{

    @Test
    public void Asistencia_Averia_Bateria() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(bateria) para coche gris en superficie");
        ...
        //TEST START .- Assistance Car Battery
        ...
        if(verifyNumberOfPolicy>0) {
            for (int x = 1; x <= verifyNumberOfPolicy; x++) {
                ...
                if (x == verifyNumberOfPolicy) {
                    node2.log(Status.FAIL, "NO report available");
        ...
        Utilities.sleep(5000);
        assistanceScreen.clickCarAssistanceBattery();
        Utilities.sleep(5000);
        assistanceScreen.clickResponseYesBatteryCar();
        Utilities.sleep(5000);
        ...
        Utilities.sleep(5000);
        node3.log(Status.PASS, "Assitance - Steps Completely successfully");
