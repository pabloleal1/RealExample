...
public class Test_03_16 extends CreateExtetReport {

    @Test
    public void Dar_Parte_Moto_Golpe_Sin_Contrarios_Otros() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, moto, tiene un golpe roce o impacto, sin contrarios, Otros daños");
        ...
        Assert.assertTrue(reportsScreen.verifyTeHaOcurridoScreenISShown() && verifyNumberOfPolicy<=0,"Este usuario no tiene permisos para dar este tipo de partes");
