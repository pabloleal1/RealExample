...
public class Test_05_13 extends CreateExtetReport {

    @Test
    public void Editar_Datos_Tomador_Contacto_TelefonoFijo() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Editar datos del Tomador - Numero de movil");
        ...
        String reset = insuranceScreen.getPersonMobileNumber();
        ...
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Editar datos del Tomador - Numero de movil");
        ...
        insuranceScreen.scrollDown();
        insuranceScreen.clickButtonModifyInfo();
        insuranceScreen.setPersonMobileNumber(reset);
        Utilities.sleep(2000);
        insuranceScreen.scrollDown();
        insuranceScreen.clicButtonSaveData();
        Utilities.sleep(5000);
        //Verify datas were restored
        CreateExtetReport.stepsVerifications(insuranceScreen.getTextSaveDates().contains("correctamente"), node2, "Restaurar - datos del Tomador - Numero de movil");
