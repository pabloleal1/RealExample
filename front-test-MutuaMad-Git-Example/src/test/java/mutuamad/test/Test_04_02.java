...
public class Test_04_02 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_Gasolina() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(gasolina) para las rozas coche en superficie gris");
        ...
        Utilities.sleep(5000);
        assistanceScreen.clickCarAssistanceGas();
        Utilities.sleep(5000);
