...
public class Test_03_23 extends CreateExtetReport {

    @Test
    public void Dar_Parte_Tiene_Una_Averia() throws Exception {

        //Test user
        String User_Poliza_Averia= "ParteAveria";
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, tiene una averia");
        ...
        cp1.execute(User_Poliza_Averia, test1);
        ...
        Assert.assertFalse(reportsScreen.verifyTeHaOcurridoScreenISShown() && verifyNumberOfPolicy<=0,"Este usuario no tiene permisos para dar parte sobre 'Mi coche no tiene una averia'");
        ...
        CreateExtetReport.stepsVerifications(reportsScreen.verifyAnyMalfunctionOptionIsShown(), node3, "Choosing the correct claim from a range of options");
        Assert.assertTrue(reportsScreen.verifyAnyMalfunctionOptionIsShown(),"Este usuario no tiene permisos para dar parte sobre 'Mi moto no tiene una averia'");
        reportsScreen.clickAnyMalfunction();
        Utilities.sleep(2000);
