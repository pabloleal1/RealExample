...
public class Test_04_08 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_Otros_Canclar() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(otros) - Cancelar");
        ...
        //TEST START .- Assistance Car Other
        ...
        Utilities.sleep(2000);
        assistanceScreen.clickCarAssistanceOther();
        assistanceScreen.clickButtonCancel();
        Utilities.sleep(2000);
        assistanceScreen.clickButtonNoCancelAssistance();
        Utilities.sleep(5000);
        assistanceScreen.clickButtonCancel();
        Utilities.sleep(2000);
        assistanceScreen.clickButtonYesCancelAssistance();
        Utilities.sleep(2000);
