...
public class Test_04_06 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_Pinchazo() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(rudea)");
        ...
        //TEST START .- Assistance Car Wheel
        ...
        Utilities.sleep(2000);
        assistanceScreen.clickCarAssistanceWheel();
        assistanceScreen.selectYesFromSpareTypeScreen();
