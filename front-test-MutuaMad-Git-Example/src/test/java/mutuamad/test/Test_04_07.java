...
public class Test_04_07 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_Otros() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia");
        ...
        assistanceScreen.continueFromBreakDownScreen();
        Utilities.sleep(2000);
