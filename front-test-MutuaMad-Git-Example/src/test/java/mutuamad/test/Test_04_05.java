...
public class Test_04_05 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_Motor() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(motor)");
        ...
        //TEST START .- Assistance Car Engine
        ...
        Utilities.sleep(2000);
        assistanceScreen.clickCarAssistanceEngine();
