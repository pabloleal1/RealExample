...
public class Test_03_18 extends CreateExtetReport{

    @Test
    public void Dar_Parte_Moto_Robo_Moto_Sin_Aparicion() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, moto, me han robado, me han robado mi coche, NO ha aparecido");
        ...
        // Open new MotorBike report Stolen Non ShowedUp
