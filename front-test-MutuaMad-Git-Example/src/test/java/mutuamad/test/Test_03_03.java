...
public class Test_03_03 extends CreateExtetReport {

    @Test
    public void Dar_Parte_Coche_Golpe_Con_Persona_Animal_Cosa() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Dar parte, coche, tiene un golpe roce o impacto, con una persona animal o cosa");
        ...
        Assert.assertTrue(reportsScreen.verifyImprovingExperienceScreenISShown(), "La ventana de estamos mejorando tu experiencia, no es mostrada");
