...
public class Test_05_06 extends CreateExtetReport {

    @Test
    public void Reportar_Accesorios() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Mis seguros coche , ver y gestionar poliza, coche, reportar accesorios");
        ...
        //TEST START .-  Insurances. Accessories
        ...
        Utilities.sleep(2000);
        insuranceScreen.clickButtonAccessories();
        Utilities.sleep(2000);
        CreateExtetReport.stepsVerifications(insuranceScreen.getCallCenterText().contains("Por favor llama a nuestro servicio"), node2, "reportar accesorios");
