...
public class Test_04_03 extends CreateExtetReport {

    @Test
    public void Asistencia_Averia_Fallo_Electrico() throws Exception {
        ...
        //Initialize report
        test1 = extent.createTest(this.getClass().getSimpleName(), "Asistencia por averia(fallo electrico)");
        ...
        //TEST START .- Assistance Car Electricity
        ...
        Utilities.sleep(5000);
        assistanceScreen.clickCarAssistanceElectricity();
        Utilities.sleep(2000);
